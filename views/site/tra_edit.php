...
<body class="gray-bg pr" style="background:url(img/set.jpg) no-repeat center center;">
    ...
    <div class=" text-center loginscreen  animated fadeInDown" style="width:100%;height:auto;padding-top:5px;">
        <div style="width:600px;margin: 0 auto;">
            ...
            <h2 style="color:#fff;margin-left:153px;">修改交易密码</h2>

            <form action="<?=Url::toRoute('site/tra_edit')?>" method="post" >
              
                <div class="inputs" style="margin-top:20px;">
                    <span class="h_title fl" style="color:#fff;">原交易密码：</span>
                    <input type="password" class="number fl h_form_control" style="width:360px;"  name="tra_pwd" minlength="6"  maxlength="20" placeholder="请输入交易密码" required >                   
                </div>
                
                <div class="inputs" style="margin-top:20px;">
                    <span class="h_title fl" style="color:#fff;">新交易密码：</span>
                    <input type="password" class="number fl h_form_control" style="width:360px;"name="new_pwd1" minlength="6"  maxlength="20" placeholder="请设置6~20位交易密码" 
                    required>
